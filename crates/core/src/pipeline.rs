...
mod tests {
    ...
    fn build_entity_links_folds_email_and_slash_forms_onto_canonical_person() {
        ...
        assert!(
            !slugs.contains(&"samantha-ccrxbreese-com"),
        ...
        assert!(
            samantha
                .aliases
                .iter()
                .any(|a| a == "samantha@ccrxbreese.com"),
    ...
    fn strip_email_domain_returns_localpart_only_for_valid_emails() {
        ...
        assert_eq!(strip_email_domain("samantha@ccrxbreese.com"), "samantha");
